document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        fr: {
            ...
            'nav-contact': 'Contact',
            'hero-title': 'AI Applied Scientist',
            'hero-description': 'Recherche doctorale en Intelligence Artificielle à Polytechnique Montréal sur l\'IA appliquée à la gestion d\'actifs.',
        ...
        en: {
            ...
            'nav-contact': 'Contact',
            'hero-title': 'AI Applied Scientist',
            'hero-description': 'Doctoral research in Artificial Intelligence at Polytechnique Montréal, focusing on the application of AI to intelligent asset management.',
